...
@login_required
@user_passes_test(
    lambda u: u.has_perm("core.add_user") or u.has_perm("modoboa_admin.add_alias")
)
def export_identities(request):
    ctx = {
        ...
        "formid": "exportform",
        "action": reverse("modoboa_admin:identity_export"),
    }
...
def export_domains(request):
    ctx = {
        ...
        "action_classes": "submit",
        "formid": "exportform",
        "action": reverse("modoboa_admin:domain_export"),
    }
